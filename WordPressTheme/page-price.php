        ...
        <div class="priceBox__container" id="Price1">
          ...
          <div class="priceBox__items">
            ...
            <dl class="priceBox__wrapper">
              ...
              <dd class="priceBox__price">&#165;<?php echo $license_price; ?></dd>
            </dl>
            <?php endif; ?>
            <?php } ?>
          </div>
        ...
        <div class="priceBox__container" id="Price2">
          ...
          <div class="priceBox__items">
            ...
            <dl class="priceBox__wrapper">
              ...
              <dd class="priceBox__price">&#165;<?php echo $experience_price; ?></dd>
            </dl>
            <?php endif; ?>
            <?php } ?>
          </div>
        ...
        <div class="priceBox__container" id="Price3">
          ...
          <div class="priceBox__items">
            ...
            <dl class="priceBox__wrapper">
              ...
              <dd class="priceBox__price">&#165;<?php echo $fan_price; ?></dd>
            </dl>
            <?php endif; ?>
            <?php } ?>
          </div>
        ...
        <div class="priceBox__container" id="Price4">
          ...
          <div class="priceBox__items">
            ...
            <dl class="priceBox__wrapper">
              ...
              <dd class="priceBox__price">&#165;<?php echo $special_price; ?></dd>
            </dl>
            <?php endif; ?>
            <?php } ?>
          </div>
